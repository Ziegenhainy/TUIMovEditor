...
def main():
    mov = TUIMov(80, 30, "./examples/test.tuimov")
    ...
    mov.add_action(TUIAction(mov.remove_object, (text2,), TUITime(1,0)))

    uwu_tweens = text4.move_tween(10,20, TUITime(3))
    mov.cursor = TUITime(1,BILLION//2)
    mov.add_tweens(uwu_tweens)
    text_uwu_tween = text4.write_tween(" I am femboy",TUITime(2))
    mov.add_tween(text_uwu_tween)
